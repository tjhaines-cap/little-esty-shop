...
RSpec.describe 'Admin invoices show page' do
  ...
  describe "Group project tasks" do
    before :each do
  ...
  describe "Individual Project Tasks" do
    before :each do
    ...
    it "displays total revenue and discounted revenue for an invoice" do
      visit "/admin/invoices/#{@invoice_1.id}"

      expect(page).to have_content("Total Revenue: $11,700.00")
      expect(page).to have_content("Discounted Revenue: $9,615.00")
    end
  end
end
